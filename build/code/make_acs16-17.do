...
quietly infix                 ///
  ...
  int     bpl        110-112  ///
  long    bpld       113-117  ///
  int     ancestr1   118-120  ///
  int     ancestr1d  121-124  ///
  byte    citizen    125-125  ///
  int     yrimmig    126-129  ///
  byte    yrsusa1    130-131  ///
  byte    educ       132-133  ///
  int     educd      134-136  ///
  byte    empstat    137-137  ///
  byte    empstatd   138-139  ///
  byte    labforce   140-140  ///
  int     occ        141-144  ///
  int     ind        145-148  ///
  byte    uhrswork   149-150  ///
  byte    looking    151-151  ///
  byte    workedyr   152-152  ///
  long    inctot     153-159  ///
  long    ftotinc    160-166  ///
  long    incwage    167-172  ///
  byte    movedin    173-173  ///
  long    pwpuma00   174-178  ///
  byte    tranwork   179-180  ///
  int     trantime   181-183  ///
  using `"./data/acs16-17/usa_00024.dat"'

...
quietly infix                  ///
  ...
  int     conspuma    48-50    ///
  int     cpuma0010   51-54    ///
  double  pumaarea    55-68    ///
  byte    gq          69-69    ///
  byte    farm        70-70    ///
  byte    ownershp    71-71    ///
  byte    ownershpd   72-73    ///
  byte    mortgage    74-74    ///
  long    mortamt1    75-79    ///
  byte    taxincl     80-80    ///
  byte    insincl     81-81    ///
  ...
  long    hhincome    90-96    ///
  long    valueh      97-103   ///
  byte    vehicles    104-104  ///
  int     pernum      105-108  ///
  double  perwt       109-118  ///
  byte    relate      119-120  ///
  int     related     121-124  ///
  byte    sex         125-125  ///
  int     age         126-128  ///
  ...
  int     bpl         142-144  ///
  long    bpld        145-149  ///
  byte    citizen     150-150  ///
  int     yrimmig     151-154  ///
  byte    yrsusa1     155-156  ///
  byte    school      157-157  ///
  byte    educ        158-159  ///
  int     educd       160-162  ///
  byte    empstat     163-163  ///
  byte    empstatd    164-165  ///
  byte    labforce    166-166  ///
  int     occ         167-170  ///
  int     ind         171-174  ///
  byte    wkswork1    175-176  ///
  byte    uhrswork    177-178  ///
  byte    looking     179-179  ///
  byte    workedyr    180-180  ///
  long    inctot      181-187  ///
  long    ftotinc     188-194  ///
  long    incwage     195-200  ///
  byte    migrate5    201-201  ///
  byte    migrate5d   202-203  ///
  int     migplac5    204-206  ///
  byte    movedin     207-207  ///
  byte    disabwrk    208-208  ///
  long    pwpuma00    209-213  ///
  byte    tranwork    214-215  ///
  int     trantime    216-218  ///
  using `"./data/census2000/usa_00018.dat"'
...
label var pumaarea   `"PUMA total area"'

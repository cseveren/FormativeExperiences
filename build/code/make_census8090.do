...
quietly infix                  ///
  ...
  int     bpl         126-128  ///
  long    bpld        129-133  ///
  byte    citizen     134-134  ///
  int     yrimmig     135-138  ///
  byte    school      139-139  ///
  byte    educ        140-141  ///
  int     educd       142-144  ///
  byte    empstat     145-145  ///
  byte    empstatd    146-147  ///
  byte    labforce    148-148  ///
  int     occ         149-152  ///
  int     ind         153-156  ///
  byte    wkswork1    157-158  ///
  byte    uhrswork    159-160  ///
  byte    looking     161-161  ///
  byte    workedyr    162-162  ///
  long    inctot      163-169  ///
  long    ftotinc     170-176  ///
  long    incwage     177-182  ///
  byte    migrate5    183-183  ///
  byte    migrate5d   184-185  ///
  int     migplac5    186-188  ///
  byte    movedin     189-189  ///
  byte    disabwrk    190-190  ///
  byte    tranwork    191-192  ///
  int     trantime    193-195  ///
  using `"./data/census8090/usa_00020.dat"'
